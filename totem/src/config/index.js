...
const intervals = {
  totemtIimeout: 120000, // Time of inactivity for the totem to reset (clean pending basket, reset selected category, reload categories and products from server)
