...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetLastTransactionResponseHosts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetLastTransactionResponseHosts'));
  } else {
    // Browser globals (root is window)
    if (!root.SimpleTransactionPosnetDeviceIntegratorApi) {
      root.SimpleTransactionPosnetDeviceIntegratorApi = {};
    }
    root.SimpleTransactionPosnetDeviceIntegratorApi.GetLastTransactionResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient, root.SimpleTransactionPosnetDeviceIntegratorApi.GetLastTransactionResponseHosts);
  }
}(this, function(ApiClient, GetLastTransactionResponseHosts) {
  'use strict';
  ...
  /**
   * The GetLastTransactionResponse model module.
   * @module model/GetLastTransactionResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>GetLastTransactionResponse</code>.
   * @alias module:model/GetLastTransactionResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetLastTransactionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetLastTransactionResponse} obj Optional instance to populate.
   * @return {module:model/GetLastTransactionResponse} The populated <code>GetLastTransactionResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Hosts')) {
        obj['Hosts'] = ApiClient.convertToType(data['Hosts'], [GetLastTransactionResponseHosts]);
      }
  ...
  /**
   * Version del Device Integrator utilizada.
   ...
   * @member {module:model/GetLastTransactionResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
  ...
  /**
   * Array de elementos JSON que contendrá cada uno de los distintos hosts con los que pueda operar el dispositivo.
   * @member {Array.<module:model/GetLastTransactionResponseHosts>} Hosts
   */
   ...
   * @member {module:model/GetLastTransactionResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/GetLastTransactionResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
  ...
  /**
   * ID utilizado para caracterizar al medio de pago de distintas formas, como puede ser 'Tarjeta de credito/debito', 'Tarjeta de beneficios', etc. La relación entre el CardAbbreviation y este identificador es personalizable por el cliente, gracias al archivo localizado en la carpeta etc, llamado MerchantPaymentMethodIDs.
   ...
   * @member {module:model/GetLastTransactionResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/GetLastTransactionResponse.CardInputModeEnum} CardInputMode
   */
   ...
   * @member {module:model/GetLastTransactionResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
   ...
   * @member {module:model/GetLastTransactionResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
   ...
   * @member {module:model/GetLastTransactionResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripcion del operador GRE con el cual se realizó la recarga.
   * @member {module:model/GetLastTransactionResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
  ...
  exports.TransactionResponseTypeEnum = {
     ...
     * @const
     */
    "CtlsReturn": "CtlsReturn",
    /**
     * value: "BuyWithCashback"
     * @const
     */
    "BuyWithCashback": "BuyWithCashback",
    /**
     * value: "BatchClose"
     * @const
     */
