...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CtlsReturnResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CtlsReturnResponse model module.
   * @module model/CtlsReturnResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CtlsReturnResponse</code>.
   * @alias module:model/CtlsReturnResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CtlsReturnResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CtlsReturnResponse} obj Optional instance to populate.
   * @return {module:model/CtlsReturnResponse} The populated <code>CtlsReturnResponse</code> instance.
   */
   ...
   * @member {module:model/CtlsReturnResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {module:model/CtlsReturnResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/CtlsReturnResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
   ...
   * @member {module:model/CtlsReturnResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/CtlsReturnResponse.CardInputModeEnum} CardInputMode
   */
   ...
   * @member {module:model/CtlsReturnResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
   ...
   * @member {module:model/CtlsReturnResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
  ...
  /**
   * Fecha de la operación original. Este campo solo estará presente en operaciones Return.
   ...
   * @member {module:model/CtlsReturnResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripción del operador GRE con el cual se realizó la recarga.
   * @member {module:model/CtlsReturnResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
