...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.BuyWithCashbackRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The BuyWithCashbackRequest model module.
   * @module model/BuyWithCashbackRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>BuyWithCashbackRequest</code>.
   * @alias module:model/BuyWithCashbackRequest
   * @class
   * @param transactionRequestType {module:model/BuyWithCashbackRequest.TransactionRequestTypeEnum} Tipo de Operación o Transacción que se quiere realizar.
   * @param transactionResolutionMode {module:model/BuyWithCashbackRequest.TransactionResolutionModeEnum} Forma de resolución en la que será realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline el dispositivo solicitará el código de autorización correspondiente por pantalla.
   */
  ...
  /**
   * Constructs a <code>BuyWithCashbackRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BuyWithCashbackRequest} obj Optional instance to populate.
   * @return {module:model/BuyWithCashbackRequest} The populated <code>BuyWithCashbackRequest</code> instance.
   */
   ...
   * @member {module:model/BuyWithCashbackRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
   ...
   * @member {module:model/BuyWithCashbackRequest.TransactionCurrencyCodeEnum} TransactionCurrencyCode
   */
   ...
   * @member {module:model/BuyWithCashbackRequest.TransactionResolutionModeEnum} TransactionResolutionMode
   * @default 'Online'
   */
  ...
  /**
   * Número de factura al cual se asociará el ticket de esta transacción. Si este valor no es enviado hacia el dispositivo, será solicitado en su pantalla para ser ingresado. Puede dejarse vacio, y así será impreso en el ticket. 
   ...
   * @member {Array.<module:model/BuyWithCashbackRequest.TicketsToPrintEnum>} TicketsToPrint
   */
