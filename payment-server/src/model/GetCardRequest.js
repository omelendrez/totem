...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.GetCardRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The GetCardRequest model module.
   * @module model/GetCardRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>GetCardRequest</code>.
   * @alias module:model/GetCardRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>GetCardRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCardRequest} obj Optional instance to populate.
   * @return {module:model/GetCardRequest} The populated <code>GetCardRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ReadExpiration')) {
        obj['ReadExpiration'] = ApiClient.convertToType(data['ReadExpiration'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {module:model/GetCardRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
  exports.prototype['TransactionRequestType'] = undefined;
  /**
   * Tipo de Operación Financiera que será realizada posteriormente con esta lectura de tarjeta previa.
   * @member {module:model/GetCardRequest.TransactionTypeEnum} TransactionType
   */
  exports.prototype['TransactionType'] = undefined;
  /**
   * Tiempo de expiración del reconocimiento de tarjeta.
   * @member {Number} ReadExpiration
   */
  exports.prototype['ReadExpiration'] = undefined;
