...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.BatchCloseResponseHosts = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The BatchCloseResponseHosts model module.
   * @module model/BatchCloseResponseHosts
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>BatchCloseResponseHosts</code>.
   * Host dado
   * @alias module:model/BatchCloseResponseHosts
   * @class
   */
  ...
  /**
   * Constructs a <code>BatchCloseResponseHosts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BatchCloseResponseHosts} obj Optional instance to populate.
   * @return {module:model/BatchCloseResponseHosts} The populated <code>BatchCloseResponseHosts</code> instance.
   */
