...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BatchCloseResponseHosts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BatchCloseResponseHosts'));
  } else {
    // Browser globals (root is window)
    if (!root.SimpleTransactionPosnetDeviceIntegratorApi) {
      root.SimpleTransactionPosnetDeviceIntegratorApi = {};
    }
    root.SimpleTransactionPosnetDeviceIntegratorApi.BatchCloseResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient, root.SimpleTransactionPosnetDeviceIntegratorApi.BatchCloseResponseHosts);
  }
}(this, function(ApiClient, BatchCloseResponseHosts) {
  'use strict';
  ...
  /**
   * The BatchCloseResponse model module.
   * @module model/BatchCloseResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>BatchCloseResponse</code>.
   * @alias module:model/BatchCloseResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>BatchCloseResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BatchCloseResponse} obj Optional instance to populate.
   * @return {module:model/BatchCloseResponse} The populated <code>BatchCloseResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Hosts')) {
        obj['Hosts'] = ApiClient.convertToType(data['Hosts'], [BatchCloseResponseHosts]);
      }
  ...
  /**
   * Tipo de dispositivo con el que interactúa este aplicativo y que será utilizado para realizar las peticiones que sean procesadas por el Device Integrator.
   ...
   * @member {module:model/BatchCloseResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {Array.<module:model/BatchCloseResponseHosts>} Hosts
   */
