...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.BuyResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
   ...
   * @member {module:model/BuyResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {module:model/BuyResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/BuyResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
  ...
  /**
   * Tipo de medio de pago utilizado por el sistema integrado al DeviceIntegrator. La relación entre el CardAbbreviation y este identificador se configura en al archivo MerchantPaymentMethodIDs, localizado en la carpeta etc.
   ...
   * @member {module:model/BuyResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/BuyResponse.CardInputModeEnum} CardInputMode
   */
  exports.prototype['CardInputMode'] = undefined;
  /**
   * Descripcion de la forma en la cual se realizó el ingreso de la tarjeta. Hay una lista de posibles valores.
   * @member {module:model/BuyResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
  ...
  /**
   * Descripcion del tipo de cuenta asociada a una operación de Débito.
   * @member {module:model/BuyResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
  ...
  /**
   * Cantidad de cuotas con el cual se realizó la transacción.
   ...
   * @member {module:model/BuyResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripción del operador GRE con el cual se realizó la recarga.
   * @member {module:model/BuyResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
  ...
  /**
   * Última versión del contrato disponible para el aplicativo instalado.
