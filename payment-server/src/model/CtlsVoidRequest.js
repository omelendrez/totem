...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CtlsVoidRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CtlsVoidRequest model module.
   * @module model/CtlsVoidRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CtlsVoidRequest</code>.
   * @alias module:model/CtlsVoidRequest
   * @class
   * @param transactionRequestType {module:model/CtlsVoidRequest.TransactionRequestTypeEnum} Tipo de Operación o Transacción que se quiere realizar.
   * @param transactionResolutionMode {module:model/CtlsVoidRequest.TransactionResolutionModeEnum} Forma de resolución en la que será realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline el dispositivo solicitará el código de autorización correspondiente por pantalla.
   */
  ...
  /**
   * Constructs a <code>CtlsVoidRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CtlsVoidRequest} obj Optional instance to populate.
   * @return {module:model/CtlsVoidRequest} The populated <code>CtlsVoidRequest</code> instance.
   */
   ...
   * @member {module:model/CtlsVoidRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
   ...
   * @member {module:model/CtlsVoidRequest.TransactionCurrencyCodeEnum} TransactionCurrencyCode
   */
   ...
   * @member {module:model/CtlsVoidRequest.TransactionResolutionModeEnum} TransactionResolutionMode
   * @default 'Online'
   */
   ...
   * @member {Array.<module:model/CtlsVoidRequest.TicketsToPrintEnum>} TicketsToPrint
   */
