...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CurrenciesRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
   ...
   * @member {module:model/CurrenciesRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
