...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CtlsVoidResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CtlsVoidResponse model module.
   * @module model/CtlsVoidResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CtlsVoidResponse</code>.
   * @alias module:model/CtlsVoidResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CtlsVoidResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CtlsVoidResponse} obj Optional instance to populate.
   * @return {module:model/CtlsVoidResponse} The populated <code>CtlsVoidResponse</code> instance.
   */
   ...
   * @member {module:model/CtlsVoidResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {module:model/CtlsVoidResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/CtlsVoidResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
   ...
   * @member {module:model/CtlsVoidResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/CtlsVoidResponse.CardInputModeEnum} CardInputMode
   */
   ...
   * @member {module:model/CtlsVoidResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
   ...
   * @member {module:model/CtlsVoidResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
   ...
   * @member {module:model/CtlsVoidResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripción del operador GRE con el cual se realizó la recarga.
   * @member {module:model/CtlsVoidResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
