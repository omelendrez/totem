...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CurrenciesResponseCurrencies = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CurrenciesResponseCurrencies model module.
   * @module model/CurrenciesResponseCurrencies
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CurrenciesResponseCurrencies</code>.
   * Tipo de moneda dado.
   * @alias module:model/CurrenciesResponseCurrencies
   * @class
   */
  ...
  /**
   * Constructs a <code>CurrenciesResponseCurrencies</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CurrenciesResponseCurrencies} obj Optional instance to populate.
   * @return {module:model/CurrenciesResponseCurrencies} The populated <code>CurrenciesResponseCurrencies</code> instance.
   */
  ...
  /**
   * Código de moneda en especificación ISO.
   * @member {String} Code
   */
