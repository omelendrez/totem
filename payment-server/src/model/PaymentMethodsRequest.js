...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.PaymentMethodsRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
   ...
   * @member {module:model/PaymentMethodsRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
