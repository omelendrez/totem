...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.BuyWithCashbackResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The BuyWithCashbackResponse model module.
   * @module model/BuyWithCashbackResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>BuyWithCashbackResponse</code>.
   * @alias module:model/BuyWithCashbackResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>BuyWithCashbackResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BuyWithCashbackResponse} obj Optional instance to populate.
   * @return {module:model/BuyWithCashbackResponse} The populated <code>BuyWithCashbackResponse</code> instance.
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.CardInputModeEnum} CardInputMode
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
   ...
   * @member {module:model/BuyWithCashbackResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripción del operador GRE con el cual se realizó la recarga.
   * @member {module:model/BuyWithCashbackResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
  ...
  /**
   * Version del contrato con la cual fue generada esta respuesta. Si no se ha solicitado una version en particular mediante la url de la petición, se enviará el mismo valor que en el campo LastContractVersionAvailable.
