...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.BatchCloseRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The BatchCloseRequest model module.
   * @module model/BatchCloseRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>BatchCloseRequest</code>.
   * @alias module:model/BatchCloseRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>BatchCloseRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BatchCloseRequest} obj Optional instance to populate.
   * @return {module:model/BatchCloseRequest} The populated <code>BatchCloseRequest</code> instance.
   */
   ...
   * @member {module:model/BatchCloseRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
