...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.ConfirmTransactionResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The ConfirmTransactionResponse model module.
   * @module model/ConfirmTransactionResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>ConfirmTransactionResponse</code>.
   * @alias module:model/ConfirmTransactionResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ConfirmTransactionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConfirmTransactionResponse} obj Optional instance to populate.
   * @return {module:model/ConfirmTransactionResponse} The populated <code>ConfirmTransactionResponse</code> instance.
   */
   ...
   * @member {module:model/ConfirmTransactionResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
