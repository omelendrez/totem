...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.VoidRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
   ...
   * @class
   * @param transactionRequestType {module:model/VoidRequest.TransactionRequestTypeEnum} Tipo de Operación o Transacción que se quiere realizar.
   * @param transactionResolutionMode {module:model/VoidRequest.TransactionResolutionModeEnum} Forma de resolución en la que será realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline, el dispositivo solicitará el código de autorización correspondiente por pantalla.
   */
   ...
   * @member {module:model/VoidRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
   ...
   * @member {module:model/VoidRequest.TransactionCurrencyCodeEnum} TransactionCurrencyCode
   */
   ...
   * @member {module:model/VoidRequest.TransactionResolutionModeEnum} TransactionResolutionMode
   * @default 'Online'
   */
   ...
   * @member {Array.<module:model/VoidRequest.TicketsToPrintEnum>} TicketsToPrint
   */
