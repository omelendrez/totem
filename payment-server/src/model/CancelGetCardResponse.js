...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CancelGetCardResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CancelGetCardResponse model module.
   * @module model/CancelGetCardResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CancelGetCardResponse</code>.
   * @alias module:model/CancelGetCardResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CancelGetCardResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CancelGetCardResponse} obj Optional instance to populate.
   * @return {module:model/CancelGetCardResponse} The populated <code>CancelGetCardResponse</code> instance.
   */
   ...
   * @member {module:model/CancelGetCardResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
  ...
  /**
   * Versión del contrato con la cual fue generada esta respuesta. Si no se ha solicitado una version en particular mediante la url de la petición, se enviará el mismo valor que en el campo LastContractVersionAvailable.
