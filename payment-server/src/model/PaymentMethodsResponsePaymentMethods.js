...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.PaymentMethodsResponsePaymentMethods = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The PaymentMethodsResponsePaymentMethods model module.
   * @module model/PaymentMethodsResponsePaymentMethods
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>PaymentMethodsResponsePaymentMethods</code>.
   * Medio de pago dado.
   * @alias module:model/PaymentMethodsResponsePaymentMethods
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentMethodsResponsePaymentMethods</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentMethodsResponsePaymentMethods} obj Optional instance to populate.
   * @return {module:model/PaymentMethodsResponsePaymentMethods} The populated <code>PaymentMethodsResponsePaymentMethods</code> instance.
   */
  ...
  /**
   * ID que relaciona el medio de pago al que pertenece la tarjeta en el sistema externo que realiza la petición al DeviceIntegrator. La relación entre el CardAbbreviation y este identificador es personalizable por el cliente, gracias al archivo localizado en la carpeta etc, llamado MerchantPaymentMethodIDs.
   ...
   * @member {module:model/PaymentMethodsResponsePaymentMethods.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
