...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentMethodsResponsePaymentMethods'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentMethodsResponsePaymentMethods'));
  } else {
    // Browser globals (root is window)
    if (!root.SimpleTransactionPosnetDeviceIntegratorApi) {
      root.SimpleTransactionPosnetDeviceIntegratorApi = {};
    }
    root.SimpleTransactionPosnetDeviceIntegratorApi.PaymentMethodsResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient, root.SimpleTransactionPosnetDeviceIntegratorApi.PaymentMethodsResponsePaymentMethods);
  }
}(this, function(ApiClient, PaymentMethodsResponsePaymentMethods) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PaymentMethods')) {
        obj['PaymentMethods'] = ApiClient.convertToType(data['PaymentMethods'], [PaymentMethodsResponsePaymentMethods]);
      }
   ...
   * @member {module:model/PaymentMethodsResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
  ...
  /**
   * Fecha y hora de la última vez que fueron actualizados los medios de pago disponibles en el dispositivo.
   * @member {String} LastUpdateDateTime
   */
  exports.prototype['LastUpdateDateTime'] = undefined;
  /**
   * Medios de pago disponibles por el dispositivo.
   * @member {Array.<module:model/PaymentMethodsResponsePaymentMethods>} PaymentMethods
   */
