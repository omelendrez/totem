...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.GetLastTransactionResponseHosts = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The GetLastTransactionResponseHosts model module.
   * @module model/GetLastTransactionResponseHosts
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>GetLastTransactionResponseHosts</code>.
   * Representa un host dado.
   * @alias module:model/GetLastTransactionResponseHosts
   * @class
   */
  ...
  /**
   * Constructs a <code>GetLastTransactionResponseHosts</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetLastTransactionResponseHosts} obj Optional instance to populate.
   * @return {module:model/GetLastTransactionResponseHosts} The populated <code>GetLastTransactionResponseHosts</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('TransactionsQuantity')) {
        obj['TransactionsQuantity'] = ApiClient.convertToType(data['TransactionsQuantity'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * Estado del lote luego de la solicitud de cierre de lote. 1) Enviado 0) No enviado
   * @member {Number} Sent
   */
  ...
  /**
   * Número de transacciones que tiene el lote.
   * @member {Number} TransactionsQuantity
   */
  exports.prototype['TransactionsQuantity'] = undefined;
