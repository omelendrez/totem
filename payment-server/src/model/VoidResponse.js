...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.VoidResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The VoidResponse model module.
   * @module model/VoidResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>VoidResponse</code>.
   * @alias module:model/VoidResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>VoidResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VoidResponse} obj Optional instance to populate.
   * @return {module:model/VoidResponse} The populated <code>VoidResponse</code> instance.
   */
   ...
   * @member {module:model/VoidResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {module:model/VoidResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/VoidResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
   ...
   * @member {module:model/VoidResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/VoidResponse.CardInputModeEnum} CardInputMode
   */
   ...
   * @member {module:model/VoidResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
   ...
   * @member {module:model/VoidResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
  ...
  /**
   * Número de tickets asociados a la transacción original para la cual se envió una operación Return.
   ...
   * @member {module:model/VoidResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripción del operador GRE con el cual se realizó la recarga.
   * @member {module:model/VoidResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
