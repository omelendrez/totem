...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CtlsBuyRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CtlsBuyRequest model module.
   * @module model/CtlsBuyRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CtlsBuyRequest</code>.
   * @alias module:model/CtlsBuyRequest
   * @class
   * @param transactionRequestType {module:model/CtlsBuyRequest.TransactionRequestTypeEnum} Tipo de Operación o Transacción que se quiere realizar.
   * @param transactionResolutionMode {module:model/CtlsBuyRequest.TransactionResolutionModeEnum} Forma de resolucion en la que sera realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline, el dispositivo solicitará el código de autorización correspondiente por pantalla.
   */
  ...
  /**
   * Constructs a <code>CtlsBuyRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CtlsBuyRequest} obj Optional instance to populate.
   * @return {module:model/CtlsBuyRequest} The populated <code>CtlsBuyRequest</code> instance.
   */
   ...
   * @member {module:model/CtlsBuyRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
   ...
   * @member {module:model/CtlsBuyRequest.TransactionCurrencyCodeEnum} TransactionCurrencyCode
   */
  exports.prototype['TransactionCurrencyCode'] = undefined;
  /**
   * Forma de resolucion en la que sera realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline, el dispositivo solicitará el código de autorización correspondiente por pantalla.
   * @member {module:model/CtlsBuyRequest.TransactionResolutionModeEnum} TransactionResolutionMode
   * @default 'Online'
   */
   ...
   * @member {Array.<module:model/CtlsBuyRequest.TicketsToPrintEnum>} TicketsToPrint
   */
