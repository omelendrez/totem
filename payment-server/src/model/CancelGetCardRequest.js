...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CancelGetCardRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CancelGetCardRequest model module.
   * @module model/CancelGetCardRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CancelGetCardRequest</code>.
   * @alias module:model/CancelGetCardRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>CancelGetCardRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CancelGetCardRequest} obj Optional instance to populate.
   * @return {module:model/CancelGetCardRequest} The populated <code>CancelGetCardRequest</code> instance.
   */
   ...
   * @member {module:model/CancelGetCardRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
