...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.BuyRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
   ...
   * @class
   * @param transactionRequestType {module:model/BuyRequest.TransactionRequestTypeEnum} Tipo de Operación o Transacción que se quiere realizar.
   * @param transactionResolutionMode {module:model/BuyRequest.TransactionResolutionModeEnum} Forma de resolución en la que será realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline el dispositivo solicitará el código de autorización correspondiente por pantalla.
   */
   ...
   * @member {module:model/BuyRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
   ...
   * @member {module:model/BuyRequest.TransactionCurrencyCodeEnum} TransactionCurrencyCode
   */
   ...
   * @member {module:model/BuyRequest.TransactionResolutionModeEnum} TransactionResolutionMode
   * @default 'Online'
   */
  ...
  /**
   * Monto del Cashback ( Extracash, Cashplus ) a utilizar en la transacción. Posee un formato específico. Si este valor no es enviado hacia el dispositivo, será solicitado en su pantalla para ser ingresado.
  ...
  /**
   * Número de factura a la cual se asociará el ticket de esta transacción. Si este valor no es enviado hacia el dispositivo, será solicitado en su pantalla para ser ingresado. Puede dejarse vacío, y así será impreso en el ticket. 
   ...
   * @member {Array.<module:model/BuyRequest.TicketsToPrintEnum>} TicketsToPrint
   */
