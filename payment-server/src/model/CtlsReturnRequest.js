...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.CtlsReturnRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The CtlsReturnRequest model module.
   * @module model/CtlsReturnRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>CtlsReturnRequest</code>.
   * @alias module:model/CtlsReturnRequest
   * @class
   * @param transactionRequestType {module:model/CtlsReturnRequest.TransactionRequestTypeEnum} Tipo de Operación o Transacción que se quiere realizar.
   * @param transactionResolutionMode {module:model/CtlsReturnRequest.TransactionResolutionModeEnum} Forma de resolución en la que sera realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline el dispositivo solicitará el código de autorizacion correspondiente por pantalla.
   */
  ...
  /**
   * Constructs a <code>CtlsReturnRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CtlsReturnRequest} obj Optional instance to populate.
   * @return {module:model/CtlsReturnRequest} The populated <code>CtlsReturnRequest</code> instance.
   */
   ...
   * @member {module:model/CtlsReturnRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
   ...
   * @member {module:model/CtlsReturnRequest.TransactionCurrencyCodeEnum} TransactionCurrencyCode
   */
  exports.prototype['TransactionCurrencyCode'] = undefined;
  /**
   * Forma de resolución en la que sera realizada la transacción. Si este valor no es recibido, habrá uno a utilizar por default. Para poder realizar una operación de forma offline el dispositivo solicitará el código de autorizacion correspondiente por pantalla.
   * @member {module:model/CtlsReturnRequest.TransactionResolutionModeEnum} TransactionResolutionMode
   * @default 'Online'
   */
   ...
   * @member {Array.<module:model/CtlsReturnRequest.TicketsToPrintEnum>} TicketsToPrint
   */
