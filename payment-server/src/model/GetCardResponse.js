...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.GetCardResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The GetCardResponse model module.
   * @module model/GetCardResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>GetCardResponse</code>.
   * @alias module:model/GetCardResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetCardResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCardResponse} obj Optional instance to populate.
   * @return {module:model/GetCardResponse} The populated <code>GetCardResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('IssuerEntity')) {
        obj['IssuerEntity'] = ApiClient.convertToType(data['IssuerEntity'], 'String');
      }
  ...
  /**
   * Codigo de respuesta generado por el Device Integrator.
   * @member {Number} ResultCode
   */
  exports.prototype['ResultCode'] = undefined;
  /**
   * Descripción del codigo de respuesta generado por el Device Integrator.
   * @member {String} ResultMessage
   */
  exports.prototype['ResultMessage'] = undefined;
  /**
   * Tipo de Operación o Transacción que se ha realizado.
   * @member {module:model/GetCardResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {String} IssuerEntity
   */
  exports.prototype['IssuerEntity'] = undefined;
  /**
   * ID único utilizado para referenciar una marca de tarjeta específica. Con este dato será posible identificar la tarjeta leída y aplicar los descuentos, recargos, etc. deseados.
   ...
   * @member {module:model/GetCardResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
