...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.GetLastTransactionRequest = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The GetLastTransactionRequest model module.
   * @module model/GetLastTransactionRequest
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>GetLastTransactionRequest</code>.
   * @alias module:model/GetLastTransactionRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>GetLastTransactionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetLastTransactionRequest} obj Optional instance to populate.
   * @return {module:model/GetLastTransactionRequest} The populated <code>GetLastTransactionRequest</code> instance.
   */
   ...
   * @member {module:model/GetLastTransactionRequest.TransactionRequestTypeEnum} TransactionRequestType
   */
