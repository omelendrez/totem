...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.ReturnResponse = factory(root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient);
  }
  ...
  /**
   * The ReturnResponse model module.
   * @module model/ReturnResponse
   * @version 2.2.0
   */

  /**
   * Constructs a new <code>ReturnResponse</code>.
   * @alias module:model/ReturnResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ReturnResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReturnResponse} obj Optional instance to populate.
   * @return {module:model/ReturnResponse} The populated <code>ReturnResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FirstSixDigits')) {
        obj['FirstSixDigits'] = ApiClient.convertToType(data['FirstSixDigits'], 'Number');
      }
      if (data.hasOwnProperty('LastFourDigits')) {
        obj['LastFourDigits'] = ApiClient.convertToType(data['LastFourDigits'], 'Number');
      }
      if (data.hasOwnProperty('PaymentMethodID')) {
        obj['PaymentMethodID'] = ApiClient.convertToType(data['PaymentMethodID'], 'String');
      }
      if (data.hasOwnProperty('TransactionTipAmount')) {
        obj['TransactionTipAmount'] = ApiClient.convertToType(data['TransactionTipAmount'], 'Number');
      }
      if (data.hasOwnProperty('TransactionTaxAmount')) {
        obj['TransactionTaxAmount'] = ApiClient.convertToType(data['TransactionTaxAmount'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ReturnResponse.TransactionResponseTypeEnum} TransactionResponseType
   */
   ...
   * @member {module:model/ReturnResponse.CardTypeEnum} CardType
   */
   ...
   * @member {module:model/ReturnResponse.CardTypeDescriptionEnum} CardTypeDescription
   */
   ...
   * @member {module:model/ReturnResponse.MerchantPaymentMethodSupportsCashbackEnum} MerchantPaymentMethodSupportsCashback
   */
   ...
   * @member {module:model/ReturnResponse.CardInputModeEnum} CardInputMode
   */
   ...
   * @member {module:model/ReturnResponse.CardInputModeDescriptionEnum} CardInputModeDescription
   */
   ...
   * @member {module:model/ReturnResponse.AccountTypeDescriptionEnum} AccountTypeDescription
   */
  ...
  /**
   * Número de ticket asociado a la transacción original para la cual se envió una operación Return.
  ...
  /**
   * Fecha de operación original. Este campo solo estará presente en operaciones Return.
   ...
   * @member {module:model/ReturnResponse.PhoneCompanyIdentificationEnum} PhoneCompanyIdentification
   */
  exports.prototype['PhoneCompanyIdentification'] = undefined;
  /**
   * Descripción del operador GRE con el cual se realizó la recarga.
   * @member {module:model/ReturnResponse.PhoneCompanyDescriptionEnum} PhoneCompanyDescription
   */
  ...
  /**
   * ID de pago generado para esta operacion. Este campo estara presente al operar con dispositivos Clover
   * @member {String} PaymentID
   */
  exports.prototype['PaymentID'] = undefined;
  /**
   * ID de orden generado para esta operacion. Este campo estara presente al operar con dispositivos Clover
   * @member {String} OrderID
   */
  exports.prototype['OrderID'] = undefined;
  /**
   * Nombre y apellido del tarjetahabiente. Este campo estara presente al operar con dispositivos Clover
   * @member {String} CardHolderName
   */
  exports.prototype['CardHolderName'] = undefined;
  /**
   * ID de transaccion. Este campo estara presente al operar con dispositivos Clover
   * @member {String} ExternalTransactionID
   */
  exports.prototype['ExternalTransactionID'] = undefined;
  /**
   * Primeros 6 digitos de la tarjeta ingresada. Este campo estara presente al operar con dispositivos Clover
   * @member {Number} FirstSixDigits
   */
  exports.prototype['FirstSixDigits'] = undefined;
  /**
   * Ultimos 4 digitos de la tarjeta ingresada. Este campo estara presente al operar con dispositivos Clover
   * @member {Number} LastFourDigits
   */
  exports.prototype['LastFourDigits'] = undefined;
  /**
   * ID del medio de pago. Este campo estara presente al operar con dispositivos Clover
   * @member {String} PaymentMethodID
   */
  exports.prototype['PaymentMethodID'] = undefined;
  /**
   * Importe de la propina. Este campo estara presente al operar con dispositivos Clover
   * @member {Number} TransactionTipAmount
   */
  exports.prototype['TransactionTipAmount'] = undefined;
  /**
   * Importe de los impuestos cobrados sobre la operacion. Este campo estara presente al operar con dispositivos Clover
   * @member {Number} TransactionTaxAmount
   */
  exports.prototype['TransactionTaxAmount'] = undefined;
