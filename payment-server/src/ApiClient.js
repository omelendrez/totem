...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SimpleTransactionPosnetDeviceIntegratorApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://localhost:8280/PosnetDeviceIntegrator/2.2.0
     */
    this.basePath = 'http://localhost:8280/PosnetDeviceIntegrator/2.2.0'.replace(/\/+$/, '');
